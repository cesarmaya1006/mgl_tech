                                                                ...
                                                                @if (
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 table-responsive">
                                                                            <table class="table table-striped table-hover table-sm tabla_tareas_componente nowrap display w-100" id="tabla_tareas_componente_{{ $componente->id }}" style="width:100%">
                                                                                <thead class="w-100">
                                                                                    <tr>
